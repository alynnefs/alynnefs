...
2022
- Python Nordeste
    - 🎤 | Pythinder: usando Kivy para não ficar no vácuo
    - 📢 | [Divulgação](https://www.instagram.com/p/ChYbMsyMZRb/)
- Python Brasil
    - 🎤 | BINGO! Automatizando a criação de cartelas com Pillow
    - 📢 | [Divulgação](https://www.instagram.com/p/CjWSWU4LYXw/)
    - 🎬 | [Palestra](https://www.youtube.com/watch?v=7mVqRIJGa2Q)
- Comsolid
    - 🎤 | BINGO! Automatizando a criação de cartelas com Pillow
...
2021
- Castálio Podcast
    - 🎤 | Organização da Python Brasil 2021
    - 📢 | [Divulgação](https://twitter.com/castaliopod/status/1434593676500602884)
    - 🎬 | [Episódio 155](https://open.spotify.com/episode/75t28r6xj6Dsh40AL7Qnzd?si=WJvGMx1TTj6AbHFC3_2jtg&utm_source=native-share-menu)
- 60° Python Floripa
    - 🎤 | Organização da Python Brasil 2021
    - 🎬 | [Palestra](https://youtu.be/NVJRklJswBs?t=7078)

2020
- PyLadies São Paulo (Oficina de palestras)
    - 🎤 | Moça, pode repetir? - Laços de repetição com Python
    - Sem divulgação e não foi gravado 😭
- Papo Entre PyLadies
    - 🎤 | Organizando uma oficina de Python básico
    - 📢 | [Divulgação](https://www.instagram.com/p/CCUHODxH2bI/)
    - 🎬 | [Palestra](https://youtu.be/lRAkw7CHB5k?t=1401)

2019
- Just Python SP
    - 🎤 | Moça, pode repetir? - Laços de repetição com Python
    - 📢 | [Programação](https://justpython.style/) 
- Python Brasil
    - 🎤 | PyLadies Brasil
    - 📢 | [Divulgação](https://www.instagram.com/p/B2mFJs-H7dq/)

2018
- Python Brasil
    - 🎤 | Robótica com Python: Caso Robolt-0
    - 📢 | [Programação](https://2018.pythonbrasil.org.br/programacao)
    - 🎬 | [Palestra](https://www.youtube.com/watch?v=1UUptkqV4aE)
- PyLadies Fortaleza
    - 🎤 | Robótica com Python: Caso Robolt-0
    - 📢 | [Divulgação](https://www.facebook.com/PyLadiesFortaleza/photos/a.874950715916604/1729951913749809/)
...
👩🏼‍💻 Já mexi com entretenimento e conectividade para aviônicos e mexo com IIoT ("i" duplo mesmo, é Internet das Coisas Industrial). Hoje uso Flask e estou estudando Django.

💃🏼 Atualmente faço aula de heels dance faço parte de um grupo independente de jazz.
